...
BEGIN
    IF (PAQUETE IS NOT NULL) THEN
       DBMS_OUTPUT.PUT_LINE('MANTEMINIEMTO A CRUCEROS DE PAQUETE '|| PAQUETE);
    ELSE
       DBMS_OUTPUT.PUT_LINE('MANTEMINIEMTO MENSUAL NORMALITO');

    OPEN MANTENIMIENTOS;
    FETCH MANTENIMIENTOS into REGISTROS_TABLA;
    while MANTENIMIENTOS%FOUND
        LOOP
        --REGISTROS_TABLA.NUMBERO ...
        FETCH MANTENIMIENTOS into REGISTROS_TABLA;
        END LOOP;
...
BEGIN
    ...
    EXCEPTION 
        ...
        UPDATE PAQUETES SET SOBRESATURADO = 0 WHERE DISPONIBILIDAD =0; 
