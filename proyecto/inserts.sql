...
INSERT INTO SERVICIOS VALUES (1,'Servicio de crucero hasta Margarita');
INSERT INTO SERVICIOS VALUES (2,'Servicio de crucero hasta Los Roques');
INSERT INTO SERVICIOS VALUES (3,'Servicio de crucero hasta Morrocoy');
INSERT INTO SERVICIOS VALUES (4,'Servicio de Alojamiento en destino');
...
INSERT INTO HIS_SERVICIOS VALUES (DATE '2021-1-1',FECHAS_TDA(DATE '2021-1-1',DATE '2021-3-1',FECHAS_TDA.VALIDACION_PRECIO(10),FECHAS_TDA.PRECIO_TOTAL(10,DATE '2021-1-1',DATE '2021-3-1')),4,12);
...
INSERT INTO HIS_SERVICIOS VALUES (DATE '2021-1-1',FECHAS_TDA(DATE '2021-1-1',DATE '2021-2-28',FECHAS_TDA.VALIDACION_PRECIO(50),FECHAS_TDA.PRECIO_TOTAL(50,DATE '2021-1-1',DATE '2021-2-28')),2,1);
INSERT INTO HIS_SERVICIOS VALUES (DATE '2021-1-1',FECHAS_TDA(DATE '2021-1-1',DATE '2021-2-28',FECHAS_TDA.VALIDACION_PRECIO(10),FECHAS_TDA.PRECIO_TOTAL(10,DATE '2021-1-1',DATE '2021-2-28')),4,1);
...
INSERT INTO HIS_SERVICIOS VALUES (DATE '2021-1-1',FECHAS_TDA(DATE '2021-1-1',DATE '2021-3-1',FECHAS_TDA.VALIDACION_PRECIO(50),FECHAS_TDA.PRECIO_TOTAL(50,DATE '2021-1-1',DATE '2021-3-1')),3,2);
INSERT INTO HIS_SERVICIOS VALUES (DATE '2021-1-1',FECHAS_TDA(DATE '2021-1-1',DATE '2021-3-1',FECHAS_TDA.VALIDACION_PRECIO(10),FECHAS_TDA.PRECIO_TOTAL(10,DATE '2021-1-1',DATE '2021-3-1')),4,2);
...
INSERT INTO PAQUETES VALUES (1,DATOS_TDA('E-C Margarita','Un paquete hacia la isla de margarita'));
INSERT INTO PAQUETES VALUES (2,DATOS_TDA('E-C Los Roques','Un paquete por los roques'));
INSERT INTO PAQUETES VALUES (3,DATOS_TDA('E-C Morrocoy','Un paquete hacia el parque nacional morrocoy'));
INSERT INTO PAQUETES VALUES (4,DATOS_TDA('E-C Adicora','Un paquete Por adicora'));
INSERT INTO PAQUETES VALUES (5,DATOS_TDA('E-C Falcon','Un paquete hacia el parque nacional morrocoy'));
INSERT INTO PAQUETES VALUES (6,DATOS_TDA('E-C Cata','Un paquete por la bahia de cata'));
INSERT INTO PAQUETES VALUES (7,DATOS_TDA('E-C Choroni','Un paquete hacia choroni'));
INSERT INTO PAQUETES VALUES (8,DATOS_TDA('E-C Caribe','Un paquete por las costas del caribe'));
INSERT INTO PAQUETES VALUES (9,DATOS_TDA('E-C Piritu','Un paquete por puerto piritu'));
INSERT INTO PAQUETES VALUES (10,DATOS_TDA('E-C Mochima','Un paquete por mochima'));
INSERT INTO PAQUETES VALUES (11,DATOS_TDA('E-C Playa medina','Un paquete hacia un paisage idilico'));
INSERT INTO PAQUETES VALUES (12,DATOS_TDA('E-C Coche','Un paquete hacia las una de las playas mas cristalinas'));
INSERT INTO PAQUETES VALUES (13,DATOS_TDA('E-C Cubagua','Un paquete hacia un lugar poco comun'));
INSERT INTO PAQUETES VALUES (14,DATOS_TDA('E-C La Orchila','Un paquete hacia la isla presidencial'));
INSERT INTO PAQUETES VALUES (15,DATOS_TDA('E-C Dependencias Federales','Un paquete por las hermosas dependencias federales'));

INSERT INTO HIS_PAQUETES VALUES (DATE '2021-1-1',FECHAS_TDA(DATE '2021-1-1',DATE '2021-1-20',FECHAS_TDA.VALIDACION_PRECIO(100.1),FECHAS_TDA.PRECIO_TOTAL(100.1,DATE '2021-1-1',DATE '2021-1-20')),1000,1,1);
INSERT INTO HIS_PAQUETES VALUES (DATE '2021-1-1',FECHAS_TDA(DATE '2021-1-1',DATE '2021-1-20',FECHAS_TDA.VALIDACION_PRECIO(20),FECHAS_TDA.PRECIO_TOTAL(20,DATE '2021-1-1',DATE '2021-1-20')),1000,4,1);
INSERT INTO HIS_PAQUETES VALUES (DATE '2021-1-1',FECHAS_TDA(DATE '2021-1-1',DATE '2021-1-20',FECHAS_TDA.VALIDACION_PRECIO(10),FECHAS_TDA.PRECIO_TOTAL(10,DATE '2021-1-1',DATE '2021-1-20')),1000,5,1);
INSERT INTO HIS_PAQUETES VALUES (DATE '2021-1-1',FECHAS_TDA(DATE '2021-1-1',DATE '2021-1-20',FECHAS_TDA.VALIDACION_PRECIO(10),FECHAS_TDA.PRECIO_TOTAL(10,DATE '2021-1-1',DATE '2021-1-20')),1000,6,1);
INSERT INTO HIS_PAQUETES VALUES (DATE '2021-1-1',FECHAS_TDA(DATE '2021-1-1',DATE '2021-1-20',FECHAS_TDA.VALIDACION_PRECIO(10),FECHAS_TDA.PRECIO_TOTAL(10,DATE '2021-1-1',DATE '2021-1-20')),1000,7,1);

INSERT INTO HIS_PAQUETES VALUES (DATE '2021-1-10',FECHAS_TDA(DATE '2021-1-10',DATE '2021-2-2',FECHAS_TDA.VALIDACION_PRECIO(100),FECHAS_TDA.PRECIO_TOTAL(100,DATE '2021-1-10',DATE '2021-2-2')),500,2,2);
INSERT INTO HIS_PAQUETES VALUES (DATE '2021-1-10',FECHAS_TDA(DATE '2021-1-10',DATE '2021-2-2',FECHAS_TDA.VALIDACION_PRECIO(20),FECHAS_TDA.PRECIO_TOTAL(20,DATE '2021-1-10',DATE '2021-2-2')),500,4,2);
...
INSERT INTO HIS_PAQUETES VALUES (DATE '2021-1-5',FECHAS_TDA(DATE '2021-1-5',DATE '2021-1-30',FECHAS_TDA.VALIDACION_PRECIO(100),FECHAS_TDA.PRECIO_TOTAL(100,DATE '2021-1-5',DATE '2021-1-30')),300,3,3);
INSERT INTO HIS_PAQUETES VALUES (DATE '2021-1-5',FECHAS_TDA(DATE '2021-1-5',DATE '2021-1-30',FECHAS_TDA.VALIDACION_PRECIO(20),FECHAS_TDA.PRECIO_TOTAL(20,DATE '2021-1-5',DATE '2021-1-30')),300,4,3);
...
INSERT INTO PCRS VALUES (2,DATE '2021-1-2',0,2,2);
INSERT INTO PCRS VALUES (3,DATE '2021-1-3',0,3,3);
INSERT INTO PCRS VALUES (4,DATE '2021-1-4',0,4,4);
INSERT INTO PCRS VALUES (5,DATE '2021-1-5',0,5,5);
INSERT INTO PCRS VALUES (6,DATE '2021-1-6',0,6,6);
INSERT INTO PCRS VALUES (7,DATE '2021-1-7',0,7,7);
INSERT INTO PCRS VALUES (8,DATE '2021-1-8',0,8,8);
INSERT INTO PCRS VALUES (9,DATE '2021-1-9',0,9,9);
INSERT INTO PCRS VALUES (10,DATE '2021-1-10',0,10,10);
INSERT INTO PCRS VALUES (11,DATE '2021-1-11',0,11,11);
INSERT INTO PCRS VALUES (12,DATE '2021-1-12',0,12,12);
INSERT INTO PCRS VALUES (13,DATE '2021-1-13',0,13,13);
INSERT INTO PCRS VALUES (14,DATE '2021-1-14',0,14,14);
INSERT INTO PCRS VALUES (15,DATE '2021-1-15',0,15,15);
